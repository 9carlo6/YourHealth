...
struct appointmentuser: View {
    ...
    @State var eventsss = [Events(date: "Jan 01, 2020", spec: "Luca Giordano", via:"Via Benevento 28, 83000", status:"Completed"), Events(date: "Jan 18, 2020", spec: "Giulia Giordano", via:"Via Benevento 28, 83000", status:"In corso")]
             ...
             // se ha gia un centro
                NavigationView{
                    ZStack{
                        ...
                        VStack{
                            VStack{
                                ForEach(self.eventsss){event in
